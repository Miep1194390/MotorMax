            ...
            <h1 className="sidebar-username">{username}</h1>
                <div className="sidebar-links">
                    <div className="sidebar-link">
                        ...
                        <input className="sidebar-search" type="text" placeholder="Zoeken" name="zoeken" id="zoeken" />
                    </div>
                    <div className="sidebar-link">
                        ...
                        <Link><p className="link">Account</p></Link>
                </div>
                <div className="sidebar-link">
                        ...
                        <Link to="/maak"><p className="link">Maken</p></Link>
                    </div>
                    <div className="sidebar-link">
                        ...
                        <Link><p className="link">Chatberichten</p></Link>
                    </div>
                    <div className="sidebar-link">
                        ...
                        <Link to="/vrienden"><p className="link">Vrienden</p></Link>
                    </div>
                    <div className="sidebar-link">
                        ...
                        <Link to="/settings"><p className="link">Instellingen</p></Link>
                    </div   >
                </div>
            <div className="content">
                <button className="sidebar-logout-button" onClick={handleLogout}>Uitloggen</button>
            </div>
        </div>
    );  
}
