    ...
    <div className="container-fluid" >
      <div className="row">
        ...
        <div className="content-left col-6 d-flex justify-content-center flex-column">
          ...
          <br />
          <button className="" onClick={() => handleClick(provider)}><p>Inloggen met Google</p></button>
          <br />
          <button className="" onClick={() => handleClick(provider)}><p>Inloggen met Microsoft</p></button>
          <br />
          <hr />
